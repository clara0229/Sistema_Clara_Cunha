...
public class Cdc_jDlgVendedorPesquisar extends javax.swing.JDialog {
     ...
     */
    public Cdc_jDlgVendedorPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cdc_jDlgVendedorPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cdc_jDlgVendedorPesquisar dialog = new Cdc_jDlgVendedorPesquisar(new javax.swing.JFrame(), true);
