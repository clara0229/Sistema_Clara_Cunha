 ...
 * @author Marcos
 */
public class Cdc_JDlgConsultaProdutos extends javax.swing.JDialog {

    /**
     * Creates new form JDlgUsuariosPesquisar
     */
    Cdc_ControllerConsultasProdutos controllerConsultasProdutos;
    ProdutosDAO produtosDAO;

    public Cdc_JDlgConsultaProdutos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consulta Produtos");
        controllerConsultasProdutos = new Cdc_ControllerConsultasProdutos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cdc_JDlgConsultaProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cdc_JDlgConsultaProdutos dialog = new Cdc_JDlgConsultaProdutos(new javax.swing.JFrame(), true);
