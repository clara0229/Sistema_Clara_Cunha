 ...
 * @author Marcos
 */
public class Cdc_JDlgConsultaClientes extends javax.swing.JDialog {

    /**
     * Creates new form JDlgUsuariosPesquisar
     */
    Cdc_ControllerConsultasClientes controllerConsultasClientes;
    ClientesDAO clientesDAO;

    public Cdc_JDlgConsultaClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consulta Clientes");
        controllerConsultasClientes = new Cdc_ControllerConsultasClientes();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cdc_JDlgConsultaClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cdc_JDlgConsultaClientes dialog = new Cdc_JDlgConsultaClientes(new javax.swing.JFrame(), true);
