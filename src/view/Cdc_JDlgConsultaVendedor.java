 ...
 * @author Marcos
 */
public class Cdc_JDlgConsultaVendedor extends javax.swing.JDialog {

    /**
     * Creates new form JDlgUsuariosPesquisar
     */
    Cdc_ControllerConsultasVendedor controllerConsultasVendedor;
    VendedorDAO vendedorDAO;

    public Cdc_JDlgConsultaVendedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consulta Vendedor");
        controllerConsultasVendedor = new Cdc_ControllerConsultasVendedor();
    ...
    private void jBtnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultaActionPerformed
        ...
        if (!jTxtValor.getText().isEmpty() && !jTxtNome.getText().isEmpty()) {
            ...
            int horas = Util.strToInt(jTxtValor.getText());
            
            List listNomeHorasTrab = (List) vendedorDAO.listNomeHorasTrab(nome, horas);
            controllerConsultasVendedor.setList(listNomeHorasTrab);
            
        } else if (!jTxtNome.getText().isEmpty()) {
            String nome = jTxtNome.getText();
            
            List listNome = (List) vendedorDAO.listNome(nome);
            controllerConsultasVendedor.setList(listNome);
            
        } else if (!jTxtValor.getText().isEmpty()){
            int horas = Util.strToInt(jTxtValor.getText());
            
            List listHorasTrab = (List) vendedorDAO.listHorasTrab(horas);
            controllerConsultasVendedor.setList(listHorasTrab);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cdc_JDlgConsultaVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cdc_JDlgConsultaVendedor dialog = new Cdc_JDlgConsultaVendedor(new javax.swing.JFrame(), true);
